...
label_result= Label(root,width=25,height=2,text="",font=("arial"))
label_result.pack()
...
Button(root,text="5", width=5, height=1, font=("arial",30,"bold"), bd=1, fg="#fff", bg="#2a2d36",command=lambda: show("4")).place(x=150,y=300)
...
Button(root,text="=", width=5, height=3, font=("arial",30,"bold"), bd=1, fg="#fff", bg="#ff914d",command=lambda: calculate()).place(x=430,y=400)
